...
channel:string="CH54b64c8dfcec482f80f757a7063038a4";
 ...
 this.channel=Mychannel;
  ...
  {
    return this.httpobj.post("https://chat.twilio.com/v2/Services/"+this.serId+"/Channels/"+this.channel+"/Messages","ServiceSid="+this.serId+"&ChannelSid="+this.channel+"&Body="+Mymsg,this.options)
  }
